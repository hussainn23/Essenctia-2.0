  ...
  const contentMap = {
    0: {
      ...
      items: [
        { number: "1", name: "Agar" },
        { number: "2", name: "BHA" },
        { number: "3", name: "Baking Powder" },
        { number: "4", name: "Benzoic Acid" },
        { number: "5", name: "BHT" },
        { number: "6", name: "Bread Crumbs" },
        { number: "7", name: "Cake Gel" },
        { number: "8", name: "Calcium Propionate" },
        { number: "9", name: "CMC" },
    ...
    1: {
      columns: "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3",
      items: [
        { number: "1", name: "Acesulfame-K" },
        { number: "2", name: "Aerosil-200(Pharma Grade)" },
        { number: "3", name: "Aspartame Powder" },
        { number: "4", name: "Avicel-200(Pharma)" },
        { number: "5", name: "Beta Carotin 10% CWS" },
        { number: "6", name: "Butyl Paraben" },
        { number: "7", name: "Caffeine Anhydrous" },
        { number: "8", name: "Citric Acid (Anhydrous)" },
        { number: "9", name: "Citric Acid (Monohydrate)" },
