...
const Drop1 = ({ onLinkClick }) => {
  return (
    <div className="absolute w-[910px] h-[494px] flex justify-between items-center flex-shrink-0 border-t border-t-[#41BA90] px-20  bg-white shadow-md z-50">
