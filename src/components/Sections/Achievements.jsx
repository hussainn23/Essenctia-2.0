...
const Achievements = () => {
  ...
  return (
    <div ref={ref} className="2xl:flex 2xl:flex-row flex flex-col-reverse justify-between items-center 2xl:pb-44 py-20 2xl:pt-40">
      <div className="flex">
        <div>
          <motion.img
            src={indus}
      ...
      <div className="mb-20">
        ...
        <div className="md:flex md:flex-row flex flex-col items-center mt-6">
          <div>
            <img
              src={vission}
              alt="vision"
